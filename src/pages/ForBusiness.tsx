...
import { BarChart3, Users2, Zap, CheckCircle } from "lucide-react";
...
const ForBusiness = () => {
  ...
  const benefits = [{
    icon: BarChart3,
    titleKey: "businessBenefit1",
    descKey: "businessBenefit1Desc"
  }, {
    icon: Users2,
    titleKey: "businessBenefit2",
    descKey: "businessBenefit2Desc"
  }, {
    icon: Zap,
    titleKey: "businessBenefit3",
    descKey: "businessBenefit3Desc"
  }];
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h1 className="text-2xl sm:text-4xl mb-4 sm:mb-6 text-red-800 font-extrabold md:text-6xl">
                {t("businessTitle")}
              </h1>
            ...
            <div className="grid gap-4 sm:gap-6 mb-12 sm:mb-16">
              {benefits.map(benefit => <div key={benefit.titleKey} className="bg-card rounded-xl p-6 sm:p-8 border border-border flex flex-col sm:flex-row items-start gap-4">
            ...
            <div className="bg-card rounded-xl p-6 sm:p-8 border border-border mb-12 sm:mb-16">
              ...
              <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
                {["feature1", "feature2", "feature3", "feature4", "feature5", "feature6"].map(key => <div key={key} className="flex items-center gap-2">
